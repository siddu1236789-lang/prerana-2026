            ...
            <Card className="flex flex-col border-primary/20 bg-card/50 hover:bg-card/80 transition-colors">
              ...
              <CardFooter>
                <Button 
                  ...
                  onClick={() => window.open('https://forms.gle/cvpkkSALCAeaC6s4A', '_blank', 'noopener')}
                >
            ...
            <Card className="flex flex-col border-secondary/20 bg-card/50 hover:bg-card/80 transition-colors">
              ...
              <CardFooter>
                <Button 
                  ...
                  onClick={() => window.open('https://forms.gle/J7drNFtCpNwJyMcE7', '_blank', 'noopener')}
                >
                  Register Now <ArrowRight className="w-4 h-4" />
                </Button>
              </CardFooter>
            ...
            <Card className="flex flex-col border-accent/20 bg-card/50 hover:bg-card/80 transition-colors">
              ...
              <CardFooter>
                <Button 
                  ...
                  onClick={() => window.open('https://forms.gle/qZHaTmpfXSqV21Em9', '_blank', 'noopener')}
                >
                  Register Now <ArrowRight className="w-4 h-4" />
                </Button>
              </CardFooter>
